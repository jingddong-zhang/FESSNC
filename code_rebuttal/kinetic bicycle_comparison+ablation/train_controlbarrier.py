...
while out_iters < 1:
    ...
    while i < max_iters:
        ...
        loss = stable_risk #+ 0.1* control_size

        L.append(loss)
        print(i, 'total loss=', loss.item(), "Lyapunov Risk=", stable_risk.item(),control_size.item())
    ...
    # torch.save(model._icnn.state_dict(),'./data/V_normal_0.5.pkl')
    # torch.save(model._control.state_dict(),'./data/control_normal_0.5.pkl')
